...
def log_conda_environment(reports_output_dir: str):
    ...
    conda_env_filehandler = open(f'{reports_output_dir}/sc_autoencoder_conda_environment.yml', "w")
    subprocess.call(['conda', 'env', 'export', '--name', 'sc_autoencoder'], stdout=conda_env_filehandler)
